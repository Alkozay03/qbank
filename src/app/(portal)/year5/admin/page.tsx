...
export default async function Year5AdminHub() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50">
        <div className="mx-auto max-w-5xl px-3 sm:px-4 py-6">
          <h1 className="text-2xl font-bold text-[#0ea5e9]">Year 5 Admin Portal</h1>
          <p className="mt-2 text-[#0284c7]">Manage schedules, questions, and notifications for Year 5.</p>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Tag Manager hidden from Year 5 Admin - only accessible from Master Admin */}

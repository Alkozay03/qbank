    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50">
      <div className="mx-auto max-w-6xl px-3 sm:px-4 py-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <button onClick={() => router.push("/year5")} className="rounded-xl border border-sky-200 bg-white px-3 py-2 text-sm font-medium text-[#0284c7] hover:bg-sky-50">← Year 5 Portal</button>
        </div>

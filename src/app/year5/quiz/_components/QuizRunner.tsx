...
const PALETTE_HEX: Record<HLColor, string> = {
  red: "#e11d48",
  green: "#16a34a",
  blue: "#56A2CD",
  yellow: "#FBF719",
...
const getSectionForRange = (range: Range) => {
  ...
  if (start.el !== end.el) return null; // require both anchors inside the same section
  return start;
};
...
export default function QuizRunner({ initialQuiz }: { initialQuiz: InitialQuiz }) {
  ...
  // Keep time per item and restore on navigation
  useEffect(() => {
                ...
                <div className="mt-3 flex items-center justify-between gap-3">
                  {[
                    ...
                    <button
                      ...
                      style={{ 
                        backgroundColor: PALETTE_HEX[k.c],

...
export default function Year3BulkQuestionManager() {
  ...
  if (isLoading) {
    return (
      <Shell title="Year 3 - Bulk Question Manager" pageName="Admin">
      ...
      <div className="rounded-2xl bg-primary-light border-2 border-primary p-6 shadow-lg">
        <div className="bg-white rounded-xl shadow-inner p-6">
          <h2 className="text-2xl font-bold text-primary mb-4">
            Pre-Clerkship Question Manager - Year 3
          </h2>
          
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
            <p className="text-blue-800 font-semibold">🚧 Under Construction</p>
            <p className="text-blue-700 text-sm mt-2">
              This is the Pre-Clerkship bulk question manager for Year 3.
          ...
          <div className="space-y-4">
            <div className="border-2 border-primary rounded-xl p-4">
              ...
              <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                <li>Add/Edit questions specific to Year 3</li>

      ...
      <div className="rounded-2xl bg-primary-light border-2 border-primary p-8 shadow-lg">
        <div className="bg-white rounded-xl shadow-inner p-6">
          ...
          <p className="text-foreground mb-4">
            The Help page for Year 3 is currently being developed.
          </p>
          <p className="text-foreground/70">
            This page will provide tutorials, FAQs, and support resources for using the Year 3 question bank.
          </p>
        </div>
      </div>
    </Shell>

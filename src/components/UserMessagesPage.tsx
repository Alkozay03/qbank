      ...
      <div className="theme-gradient p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-white opacity-90 mt-1">Send a message to the website creator.</p>
          </div>
          <button
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {messages.length === 0 ? (
                ...
                messages.map((message) => (
                  <div
                    key={message.id}
                    className={`flex ${message.sender.role === "MASTER_ADMIN" ? "justify-start" : "justify-end"}`}
                  >
